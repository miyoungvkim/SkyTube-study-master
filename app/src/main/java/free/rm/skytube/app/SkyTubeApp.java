...
/*
		Log.d("SkyTubeApp","interceptYouTubeLinks start "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
		...
		link.setOnClickListener(new Link.OnClickListener() {
			...
			public void onClick(String clickedText) {
				...
				if(videoPattern.matcher(clickedText).matches()) {
					Log.d("SkyTubeApp","videoPattern.matcher(clickedText).matches() "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());

					Log.d("SkyTubeApp","0000 "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());

					YouTubePlayer.launch(clickedText, context);
				} else if(playlistMatcher.matches()) {
					Log.d("SkyTubeApp","playlistMatcher.matches() "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());

					Log.d("SkyTubeApp","111 "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
					...
					Log.d("SkyTubeApp","222 "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
					...
					Log.d("SkyTubeApp","333 "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
