...
public class YouTubeVideo implements Serializable {
	...
	public YouTubeVideo(Video video) {
		this.id = "DpvUZnNpm0I"; // video.getId();
	...
	public static String getYouTubeIdFromUrl(String url) {
		...
		Log.d("YouTubeVideo","KMI222 url : "+url +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());

		Log.d("YouTubeVideo","KMI222 getYouTubeIdFromUrl : "+matcher.group() +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
