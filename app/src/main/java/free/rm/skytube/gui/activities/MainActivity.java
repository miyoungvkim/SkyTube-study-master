		...
		final AlertDialog alertDialog = new AlertDialog.Builder(this)
			...
			.setPositiveButton(R.string.play, new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
                    ...
                    Logger.e(this, "String = "+ videoUrl +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());

                    Logger.e(this, "KMI!!!!!!!!!! YouTubePlayer" +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
					// play the video
