...
//		});
	...
	private void initViews(View view) {
		Logger.e(this, "KMI!!!!!!!!!!" +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
		...
		Logger.e(this, "KMI!!!!!!!!!! ExoPlayerFactory.newSimpleInstance(getContext(), trackSelector);" +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
...
/*
		...
		videoDescChannelThumbnailImageView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Logger.e(this, "click!!!" +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
...
//		commentsExpandableListView = view.findViewById(R.id.commentsExpandableListView);
	...
	private void setUpHUDAndPlayVideo() {
		...
		getSupportActionBar().setTitle("KMI TEST"); // youTubeVideo.getTitle());
...
/*
	...
	private void loadVideo() {
		...
		// if (!youTubeVideo.isLiveStream()) {
			Logger.e(this, "KMI!!!!!!!!!! !youTubeVideo.isLiveStream() " +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
		...
		//	} else {
				...
				youTubeVideo.getDesiredStream(new GetDesiredStreamListener() {
					...
					public void onGetDesiredStream(StreamMetaData desiredStream) {
						...
						// play the video
						Logger.i("TAG", "KMI33 >> PLAYING: %s", desiredStream.getUri());
						Logger.e("TAG", "KMI33  PLAYING" +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
					...
					public void onGetDesiredStreamError(String errorMessage) {
						if (errorMessage != null) {
							new AlertDialog.Builder(getContext())
											...
											.setTitle("error") //R.string.error_video_play)
											.setCancelable(false)
	...
	private void playVideo(Uri videoUri) {
		Logger.e(this, "playVideo start " +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
	...
	private void playVideoExternally() {
		Logger.e(this, "playVideoExternally " +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
...
*/
	...
	private class GetVideoDetailsTask extends AsyncTaskParallel<Void, Void, YouTubeVideo> {
		...
		protected void onPreExecute() {
			...
			Logger.e(this, "KMI2 url = " + url + new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
			...
			Logger.e(this, "KMI2 video Url = " + videoUrl + new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
*/
		}
...
*/
		...
		protected YouTubeVideo doInBackground(Void... params) {
			...
			Logger.e(this, "kmi !!!!!!!!!! youtube url = " + videoId + new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
