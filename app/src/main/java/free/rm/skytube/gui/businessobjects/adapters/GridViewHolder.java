		...
		thumbnailImageView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View thumbnailView) {
				if (youTubeVideo != null) {
					...
					Log.d("GridViewHolder","thumbnailImageView.gridViewHolderListener  "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
