...
public class YouTubePlayer {
	...
	public static void launch(String videoUrl, Context context) {
		...
		Logger.e(TAG, "KMI!!!!!!!!!! " +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());

		// if the user has selected to play the videos using the official YouTube player
		// (in the preferences/settings) ...
	//	if (useOfficialYouTubePlayer(context)) {
	//		Logger.e(TAG, "KMI!!!!!!!!!! launchOfficialYouTubePlayer" +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());

	//		launchOfficialYouTubePlayer(YouTubeVideo.getYouTubeIdFromUrl(videoUrl), context);
	//	} else {
			Logger.e(TAG, "KMI!!!!!!!!!! launchCustomYouTubePlayer" +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
	...
	public static void launchCustomYouTubePlayer(YouTubeVideo youTubeVideo, Context context) {
		...
		Logger.e(TAG, "KMI!!!!!!!!!! launchCustomYouTubePlayer YouTubeVideo youTubeVideo " +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
